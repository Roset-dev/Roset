...
- [Search](/docs/features/search) -- lower-level search without LLM answer generation.
- [Build a Knowledge Base](/docs/workflows/knowledge-base) -- end-to-end upload + search + Q&A workflow.
