...
Provider keys are optional BYOK credentials for the extraction and embedding services that Roset orchestrates. Roset uses managed keys by default. Optionally provide your own keys to use your provider accounts instead.
