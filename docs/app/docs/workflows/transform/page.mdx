...
export const metadata = {
  ...
  description: 'Upload a file and get markdown, embeddings, metadata, thumbnails, and a searchable index in one call.',
}
...
Every file transformation produces up to 5 variant types. See [Variant Types](/docs/features/variants) for details on each.
