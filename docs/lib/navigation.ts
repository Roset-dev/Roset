...
export const navigation: NavEntry[] = [
  ...
  { label: "Integrations", href: "/docs/integrations" },
  {
    ...
    defaultOpen: true,
    items: [
      { label: "Advanced RAG", href: "/docs/cookbooks/advanced-rag" },
      { label: "Multi-tenant Portal", href: "/docs/cookbooks/multi-tenant-portal" },
    ],
  },
  {
    label: "Recipes",
    defaultOpen: true,
    items: [
      { label: "Invoice Extraction", href: "/docs/recipes/invoice-extraction" },
      { label: "Contract Extraction", href: "/docs/recipes/contract-extraction" },
      { label: "Resume Extraction", href: "/docs/recipes/resume-extraction" },
    ],
  },
  {
    label: "Features",
